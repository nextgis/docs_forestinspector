...
В случае необходимости, выберите и нажмите на кнопку Заполнить Ведомость перечета. 
...
В случае необходимости, выберите и нажмите на кнопку Заполнить Вид и количество продукции, 
подлежащей изъятию. На экране Продукция для изъятия нажмите на кнопку меню основных операций. 
Откроется окно добавления данных (см. :numref:`fw_produkcia_dlya_izatia_entering`).
...
Для удаления записей из списка нажмите на квадрат в правой части строки. Когда запись 
из списка выделится галочкой, то сверху экрана появится иконка с изображением корзины. 
