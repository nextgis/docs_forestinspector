...
Для удаления записей из ведомости пересчёта нажмите на квадрат в правой части строки. Когда он выделится галочкой, то сверху экрана появится иконка ведра .. image:: fw_buttons_trash.png По её нажатию удалятся отмеченные галочкой записи.
